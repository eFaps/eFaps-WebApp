    ...
    extends AbstractUIFactory
{
     ...
     * Factory Instance.
     */
    private static DateTimeUIFactory FACTORY;

    /**
     * Singelton.
     */
    private DateTimeUIFactory()
    {
    }
        ...
        throws EFapsException
    {
        ...
        if (applies(_abstractUIField)) {
            ret = new DateTimePanel(_wicketId, Model.of(_abstractUIField), _abstractUIField.getFieldConfiguration(),
                            _abstractUIField.getValue().getEditValue(_abstractUIField.getParent().getMode()), true);
        }
        return ret;
    }
    ...
    {
        if (DateTimeUIFactory.FACTORY == null) {
            DateTimeUIFactory.FACTORY = new DateTimeUIFactory();
        }
        return DateTimeUIFactory.FACTORY;
    }
}
