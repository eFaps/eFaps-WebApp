...
public class LegacyModalWindow extends Panel
{
    ...
    private static final ResourceReference JAVASCRIPT = new JavaScriptResourceReference(
                    LegacyModalWindow.class, "res/modal.js");

    private static final ResourceReference CSS = new CssResourceReference(LegacyModalWindow.class,
        "res/modal.css");
     ...
     *            Id of component
     */
    public LegacyModalWindow(final String id)
    {
        super(id);
        init();
    }
     ...
     *            Model
     */
    public LegacyModalWindow(final String id, final IModel<?> model)
    {
        super(id, model);
        init();
    }
    ...
    public void renderHead(final IHeaderResponse response)
    {
        ...
        final ResourceReference cssResource = newCssResource();
        if (cssResource != null)
        {
     ...
     * @return this
     */
    public LegacyModalWindow setPageCreator(final PageCreator creator)
    {
        setContent(empty);
        pageCreator = creator;
        return this;
     ...
     * @return this
     */
    public LegacyModalWindow setCloseButtonCallback(final CloseButtonCallback callback)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setWindowClosedCallback(final WindowClosedCallback callback)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setMinimalWidth(final int minimalWidth)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setMinimalHeight(final int minimalHeight)
    {
     ...
     * @see #newCssResource()
     */
    public LegacyModalWindow setCssClassName(final String cssClassName)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setInitialWidth(final int initialWidth)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setInitialHeight(final int initialHeight)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setUseInitialHeight(final boolean useInitialHeight)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setResizable(final boolean resizable)
    {
     ...
     */
    public LegacyModalWindow showUnloadConfirmation(final boolean unloadConfirmation)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setWidthUnit(final String widthUnit)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setHeightUnit(final String heightUnit)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setCookieName(final String cookieName)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setTitle(final String title)
    {
     ...
     * @return this
     */
    public LegacyModalWindow setTitle(IModel<String> title)
    {
        title = wrap(title);
        this.title = title;
        return this;
     ...
     * @return this
     */
    public LegacyModalWindow setMaskType(final MaskType mask)
    {
        maskType = mask;
        return this;
    }
     ...
     */
    @Override
    public LegacyModalWindow remove(final Component component)
    {
     ...
     * @return this;
     */
    public LegacyModalWindow setContent(final Component component)
    {
    ...
    protected final String getWindowOpenJavaScript()
    {
        ...
        final String title = getTitle() != null ? getTitle().getObject() : null;
        if (title != null)
        {
        ...
        if (windowClosedCallback != null)
        {
            final WindowClosedBehavior behavior = getBehaviors(WindowClosedBehavior.class).get(0);
        ...
        {
            final CloseButtonBehavior behavior = getBehaviors(CloseButtonBehavior.class).get(0);
     ...
     * @return this
     */
    public LegacyModalWindow setAutoSize(final boolean autoSize)
    {
