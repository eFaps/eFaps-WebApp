    ...
    implements IRemoteUpdateable
{
                    ...
                    final UUID _selectCmdUUID)
    {
        ...
        //
        // setDefaultModel(new Model<Serializable>((Serializable)
        // model.getTreeModel()));
        //
        ...
        // final DefaultMutableTreeNode newNode = (DefaultMutableTreeNode)
        // newNodes.nextElement();
    ...
    {
        return new MenuItem(_id, this, _model);
    }
     ...
     * @param _target
     */
    public void updateTree(final AjaxRequestTarget _target)
    {
    ...
    // getTreeState().getSelectedNodes().iterator()
    // .next();
    // final Enumeration<?> childs = node.children();
    // boolean old = false;
    // while (childs.hasMoreElements()) {
    //
    // final DefaultMutableTreeNode child = (DefaultMutableTreeNode)
    // childs.nextElement();
    //
    ...
    //
    // /**
    // * Populates the tree item. It creates all necessary components for the
    ...
    // MenuTree.ICON_CHILDOPENED));
    // } else {
    // expandLink.add(new StaticImageComponent("expandIcon",
    // MenuTree.ICON_CHILDCLOSED));
    // }
    // } else {
    ...
    //
    // page = new InlineFrame(ContentContainerPage.IFRAME_WICKETID, new
    // IPageLink() {
    //
    // private static final long serialVersionUID = 1L;
    //
    ...
    // ret = new StructurBrowserPage(_model.getCommandUUID(),
    // _model.getInstanceKey(), false);
    // } else {
    ...
    // }
    //
    // final InlineFrame component = (InlineFrame)
    // getPage().get(((ContentContainerPage) getPage()).getInlinePath());
    ...
    // if (node != null) {
    // final DefaultTreeModel treemodel = (DefaultTreeModel)
    // getComponent().getDefaultModel().getObject();
    // final UIMenuItem model = (UIMenuItem) node.getUserObject();
