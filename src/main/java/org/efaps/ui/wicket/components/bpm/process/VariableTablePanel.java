    ...
    extends Panel
{
        ...
        throws EFapsException
    {
        ...
        final List<IColumn<UIVariableInstanceLog, String>> columns = new ArrayList<IColumn<UIVariableInstanceLog, String>>();
        columns.add(new PropertyColumn<UIVariableInstanceLog, String>(new Model<String>("ID"), "id", "id"));
        ...
        columns.add(new PropertyColumn<UIVariableInstanceLog, String>(new Model<String>(variableInstanceId),
                        "variableInstanceId",
                        "variableInstanceId"));
        columns.add(new PropertyColumn<UIVariableInstanceLog, String>(new Model<String>(variableId), "variableId",
                        "variableId"));
        columns.add(new PropertyColumn<UIVariableInstanceLog, String>(new Model<String>(value), "value",
                        "value"));
        columns.add(new PropertyColumn<UIVariableInstanceLog, String>(new Model<String>(date), "date",
                        "date"));

        add(new AjaxFallbackDefaultDataTable<UIVariableInstanceLog, String>("table", columns, this.dataProvider,
