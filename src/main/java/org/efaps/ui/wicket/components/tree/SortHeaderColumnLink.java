 ...
 * @version $Id$
 */
public class SortHeaderColumnLink
    extends Link<UIStructurBrowser>
{
    ...
    public void onClick()
    {
        ...
        try {
            getRequestCycle().setResponsePage(new StructurBrowserPage(new StructurBrowserModel(structurBrowser)));
